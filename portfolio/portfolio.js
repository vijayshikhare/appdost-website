// File: portfolio/js/script.js - Enhanced with Professional Animations & Interactions
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Portfolio Filter (Enhanced with Animation)
    initPortfolioFilter();
    ...
    window.addEventListener('scroll', () => {
        ...
        scrollTimeout = setTimeout(() => {
            ...
            navLinks.forEach(link => {
                ...
                if (href.includes('portfolio.html') || (current === '' && href.includes('portfolio.html'))) {
...
// Portfolio Filter Function (Enhanced with Smooth Animations)
...
document.addEventListener('DOMContentLoaded', function() {
    const buttons = document.querySelectorAll('.btn--primary, .btn--secondary, .btn--outline, .filter-btn');
