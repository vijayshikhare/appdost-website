// File: services/js/script.js - Enhanced with Professional Animations & Interactions
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Smooth Scrolling for Anchor Links (including service tabs)
    ...
    function updateActiveTab(activeTab) {
        ...
        if (activeTab.classList.contains('tab-btn')) {
    ...
    // Active Nav Link and Tab on Scroll
    let scrollTimeout;
    window.addEventListener('scroll', () => {
...
document.addEventListener('DOMContentLoaded', function() {
    const buttons = document.querySelectorAll('.btn--primary, .btn--secondary, .btn--outline, .tab-btn');
